// INACTIVE COMMENTS MANAGER - SIMPLIFIED VERSION
// This component has been simplified to avoid errors
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-12 text-center">
        ...
        <h3 className="text-lg font-semibold text-foreground mb-2">Comments Management</h3>
        <p className="text-muted-foreground mb-6">
          Comments management functionality is currently being developed.
        </p>
        <Button disabled>
          Coming Soon
        </Button>
...
/*
// ORIGINAL COMPLEX COMMENTS MANAGER - COMMENTED OUT TO AVOID ERRORS
      ...
      <div className="space-y-4">
        ...
        {sortedComments.length > 0 && (
          <div className="flex items-center space-x-3 p-3 bg-muted/50 rounded-lg">
            <input
              type="checkbox"
              checked={selectedComments.length === sortedComments.length && sortedComments.length > 0}
              onChange={handleSelectAll}
              className="rounded border-border"
            />
            <span className="text-sm font-medium text-foreground">
              Select All ({sortedComments.length} comments)
            </span>
          </div>
        )}
